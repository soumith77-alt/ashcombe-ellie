  ...
  },
  {
    ...
    body: {
      ...
      properties: {
        ...
        firstName: str("Caller's first name, spelled back to them and confirmed. Ask for this early, not at booking time."),
        surname: str("Caller's surname, spelled out letter by letter and confirmed."),
        name: str('Only if they gave both names in one breath and you did not split them. Prefer firstName and surname.'),
